# MORGELON — Design (refocus)

See [`CONCEPTS.md`](CONCEPTS.md) for the three new horror engines.

## Pitch

A Colorado mountain horror movie/game where:

1. **The Single Tree** — clonal aspens graft hikers into one organism  
...
Valley clinic/ranger denial → switchbacks (Consensus rises) → aspen graft encounters → overlook tourism ritual → clone core → descend with Evidence or summit Joined.
...
1. **Valley Airlock** — clinic / visitor center / denial  
2. **Switchback Grade** — Consensus tutorial; radios overlap  
3. **Clone Stand** — white trunks; graft pressure; Fly macros  
4. **Overlook Temple** — leaf-peepers, tripods, DJI launch pads  
5. **Core / Treeline** — one-body reveal; unison breath  
6. **Descent / Summit fork** — endings  

## Tone

Beauty is bait. Agreement is violence. The camera is a stamen.
